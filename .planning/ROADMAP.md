...
- [x] 04-03-PLAN.md — Adaptation pages: PersonalizePage (4-step stepper wizard), WorkspacePage (3-column workspace with version timeline, iframe preview, refine, feedback, diff, rollback, export)
